...
# -*- coding: utf-8 -*-
#
# nbtools documentation build configuration file
#
...
_version_py = os.path.join(repo, 'nbtools', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'nbtools.tex', 'nbtools Documentation',
     'Thorin Tabor', 'manual'),
]
